...
- `html 태그를 보관해 두기(document.querySeletor)`
- 화면에 보여주지 않는 변수를 보관하기
- 리렌더링 해도 값을 초기화하지 않는다.
...
function App() {
  ...
  return (
    <div ref={topRef}>
      ...
      <div style={{ height: "100vh", background: "greenyellow" }}>인사말</div>
      <div ref={companyRef} style={{ height: "100vh", background: "hotpink" }}>
        회사소개
      </div>
      <button
  ...
  return (
    <div>
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/D1PvIWdJ8xo?si=W5mIg4BEaN8AK7Hq"
